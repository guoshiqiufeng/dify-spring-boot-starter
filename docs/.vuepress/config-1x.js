...
export default defineUserConfig({
    ...
    base: '/dify-spring-boot-starter-doc/1.x/',
    locales: {
        // 键名是该语言所属的子路径
        // 作为特例，默认语言可以使用 '/' 作为其路径。
        '/': {
    ...
    head: [
        ['link', {rel: 'icon', href: '/dify-spring-boot-starter-doc/1.x/images/f.ico'}],
        ['link', {rel: 'shortcut icon', href: '/dify-spring-boot-starter-doc/1.x/images/f.ico'}]
    ],
    bundler: viteBundler(),
    theme: defaultTheme({
