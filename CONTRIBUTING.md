...
So you're looking to contribute to dify-spring-boot-starter - that's awesome, we can't wait to see what you do. Any help from the community counts, truly.
...
Looking for something to tackle? Browse our [good first issues](https://github.com/guoshiqiufeng/dify-spring-boot-starter/issues?q=is%3Aissue%20state%3Aopen%20label%3A%22good%20first%20issue%22) and pick one to get started!
...
- Expected behavior
- **Logs**, if available, for backend issues, this is really important
...
| Minor fixes (typos) | Low Priority |
...
1. Refer to the implementation guide in the `.github/rules` folder for the implementation process, e.g. [server](.github/rules/server.md)
1. Please add tests for your changes accordingly
1. Ensure your code passes the existing tests
1. Please link the issue in the PR description, `fixes #<issue_number>` or `resolves #<issue_number>`
1. Get merged!
