...
public class DifyWorkflowAutoConfigurationTest {
    ...
    static class CustomDifyWorkflowHandlerConfiguration {
        ...
        DifyWorkflowClient difyWorkflowClient(DifyProperties properties) {
            SpringHttpClientFactory springHttpClientFactory = new SpringHttpClientFactory(WebClient.builder(), RestClient.builder(), new JacksonJsonMapper());
            return new DifyWorkflowDefaultClient(properties.getUrl(), properties.getClientConfig(), springHttpClientFactory);
        }
