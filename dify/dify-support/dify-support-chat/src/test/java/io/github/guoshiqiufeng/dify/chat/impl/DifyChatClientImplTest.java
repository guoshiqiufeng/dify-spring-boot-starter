...
class DifyChatClientImplTest {
    ...
    void testSite() {
        ...
        // Act
        AppSiteResponse actualResponse = difyChat.site(apiKey);
    ...
    void testFeedbacks() {
        ...
        // Act
        DifyPageResult<AppFeedbackResponse> actualResponse = difyChat.feedbacks(request);
    ...
    void testConversationVariables() {
        ...
        // Act
        DifyPageResult<ConversationVariableResponse> actualResponse = difyChat.conversationVariables(request);
    ...
    void testUpdateConversationVariable() {
        ...
        // Act
        ConversationVariableResponse actualResponse = difyChat.updateConversationVariable(request);
