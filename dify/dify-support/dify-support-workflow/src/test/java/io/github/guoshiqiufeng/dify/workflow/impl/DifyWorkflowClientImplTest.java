...
/**
 * Tests for {@link DifyWorkflowClientImpl}.
 *
 * @author yanghq
 * @version 1.0
 * @since 2025/4/24 09:08
 */
public class DifyWorkflowClientImplTest {
    ...
    public void setup() {
        ...
        difyWorkflow = new DifyWorkflowClientImpl(difyWorkflowClient);
    }
    ...
    void testRunWorkflow() {
        ...
        // Act
        WorkflowRunResponse actualResponse = difyWorkflow.runWorkflow(request);
    ...
    void testRunWorkflowStream() {
        ...
        // Act
        Flux<WorkflowRunStreamResponse> actualFlux = difyWorkflow.runWorkflowStream(request);
    ...
    void testInfo() {
        ...
        // Act
        WorkflowInfoResponse actualResponse = difyWorkflow.info(workflowRunId, apiKey);
    ...
    void testStopWorkflowStream() {
        ...
        // Act
        WorkflowStopResponse actualResponse = difyWorkflow.stopWorkflowStream(apiKey, taskId, userId);
    ...
    void testLogs() {
        ...
        // Act
        DifyPageResult<WorkflowLogs> actualResult = difyWorkflow.logs(request);
