    ...
    public DifyPageResult<ChatConversationResponse> chatConversations(ChatConversationsRequest request) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<DifyPageResult<ChatConversationResponse>>() {
                        })
                        .block()
        );
    }
    ...
    public List<DailyWorkflowConversationsResponse> dailyWorkflowConversations(String appId, java.time.LocalDateTime start, java.time.LocalDateTime end) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<DailyWorkflowConversationsResultResponse>() {
                        })
                        .map(DailyWorkflowConversationsResultResponse::getData)
                        .block()
        );
    }
    ...
    public List<DailyEndUsersResponse> dailyEndUsers(String appId, java.time.LocalDateTime start, java.time.LocalDateTime end) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<DailyEndUsersResultResponse>() {
                        })
                        .map(DailyEndUsersResultResponse::getData)
                        .block()
        );
    }
    ...
    public List<AverageSessionInteractionsResponse> averageSessionInteractions(String appId, java.time.LocalDateTime start, java.time.LocalDateTime end) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<AverageSessionInteractionsResultResponse>() {
                        })
                        .map(AverageSessionInteractionsResultResponse::getData)
                        .block()
        );
    }
    ...
    public List<TokensPerSecondResponse> tokensPerSecond(String appId, java.time.LocalDateTime start, java.time.LocalDateTime end) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<TokensPerSecondResultResponse>() {
                        })
                        .map(TokensPerSecondResultResponse::getData)
                        .block()
        );
    }
    ...
    public List<UserSatisfactionRateResponse> userSatisfactionRate(String appId, java.time.LocalDateTime start, java.time.LocalDateTime end) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<UserSatisfactionRateResultResponse>() {
                        })
                        .map(UserSatisfactionRateResultResponse::getData)
                        .block()
        );
    }
    ...
    public List<TokenCostsResponse> tokenCosts(String appId, java.time.LocalDateTime start, java.time.LocalDateTime end) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<TokenCostsResultResponse>() {
                        })
                        .map(TokenCostsResultResponse::getData)
                        .block()
        );
    }
    ...
    public List<DailyMessagesResponse> dailyMessages(String appId, java.time.LocalDateTime start, java.time.LocalDateTime end) {
        return executeWithRetry(
                () -> webClient.get()
                        ...
                        .retrieve()
                        .onStatus(HttpStatus::isError, WebClientUtil::exceptionFunction)
                        .bodyToMono(new org.springframework.core.ParameterizedTypeReference<DailyMessagesResultResponse>() {
                        })
