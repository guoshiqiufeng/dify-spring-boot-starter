...
public class DifyWorkflowDefaultClientTest extends BaseClientTest {
    ...
    public void testInfo() {
        ...
        verify(responseSpecMock).bodyToMono(WorkflowInfoResponse.class);
    }
    ...
    public void testStopWorkflowStream() {
        ...
        verify(requestBodySpecMock).header(eq(HttpHeaders.AUTHORIZATION), eq("Bearer " + apiKey));
        verify(requestBodySpecMock).bodyValue(any(HashMap.class));
        verify(responseSpecMock).bodyToMono(WorkflowStopResponse.class);
    }
