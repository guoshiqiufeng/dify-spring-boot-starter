...
public class DifyServerDefaultClient extends BaseDifyDefaultClient implements DifyServerClient {
    ...
    public AppsResponseResult apps(AppsRequest appsRequest) {
        return executeWithRetry(
                () -> {
                    ...
                    return
                            uri.cookies(this::addAuthorizationCookies)
                                    .retrieve()
    ...
    public List<ApiKeyResponse> getAppApiKey(String appId) {
        ApiKeyResultResponse tmp = executeWithRetry(
                () -> {
                    ...
                    uri.headers(this::addAuthorizationHeader);
                    return uri.cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
    ...
    public void deleteAppApiKey(String appId, String apiKeyId) {
        executeWithRetry(
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.delete()
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .queryParam("start", start.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")))
                                    .queryParam("end", end.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm")))
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    DailyConversationsResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    DailyWorkflowConversationsResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    DailyEndUsersResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    AverageSessionInteractionsResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    TokensPerSecondResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    UserSatisfactionRateResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    TokenCostsResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
                ...
                () -> {
                    RestClient.RequestHeadersSpec<?> uri = restClient.get()
                            .uri(uriBuilder -> uriBuilder
                                    ...
                                    .build(appId));
                    uri.headers(this::addAuthorizationHeader);
                    DailyMessagesResultResponse response = uri
                            .cookies(this::addAuthorizationCookies)
                            .retrieve()
                            .onStatus(responseErrorHandler)
