...
/**
 * Jackson JsonNode wrapper implementation
 *
 * @author yanghq
 * @version 2.0.0
 * @since 2025-12-31
 */
public class JacksonJsonNode implements io.github.guoshiqiufeng.dify.client.core.codec.JsonNode {
    ...
    public io.github.guoshiqiufeng.dify.client.core.codec.JsonNode get(String fieldName) {
        ...
        return child != null ? new JacksonJsonNode(child) : null;
    }
    ...
    public Iterator<io.github.guoshiqiufeng.dify.client.core.codec.JsonNode> elements() {
        ...
        node.elements().forEachRemaining(element -> elements.add(new JacksonJsonNode(element)));
