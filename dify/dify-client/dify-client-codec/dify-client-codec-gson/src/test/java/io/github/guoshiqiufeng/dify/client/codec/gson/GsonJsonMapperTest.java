...
class GsonJsonMapperTest {
    ...
    private final GsonJsonMapper mapper = GsonJsonMapper.getInstance();

    @Test
    void testGetInstance() {
        GsonJsonMapper instance1 = GsonJsonMapper.getInstance();
        GsonJsonMapper instance2 = GsonJsonMapper.getInstance();
        assertSame(instance1, instance2);
    }

    @Test
    void testGetGson() {
        assertNotNull(GsonJsonMapper.getGson());
    }
