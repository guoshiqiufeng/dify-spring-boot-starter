...
public class DifyDatasetDefaultClientTest extends BaseClientTest {
    ...
    public void setup() {
        ...
        client = new DifyDatasetDefaultClient(httpClientMock);
    }
    ...
    public void testCreate() {
        ...
        when(responseSpecMock.body(DatasetResponse.class)).thenReturn(expectedResponse);
    ...
    public void testInfo() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(DatasetInfoResponse.class)).thenReturn(expectedResponse);
    ...
    public void testCreateDocumentByText() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(DocumentCreateResponse.class)).thenReturn(expectedResponse);
    ...
    public void testRetrieve() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(RetrieveResponse.class)).thenReturn(expectedResponse);
    ...
    public void testListTextEmbedding() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(TextEmbeddingListResponse.class)).thenReturn(expectedResponse);
    ...
    public void testCreateSegment() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(SegmentResponse.class)).thenReturn(expectedResponse);
    ...
    public void testUpdateSegment() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(SegmentUpdateResponse.class)).thenReturn(expectedResponse);
    ...
    public void testCreateMetaData() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(MetaDataResponse.class)).thenReturn(expectedResponse);
    ...
    public void testListMetaData() {
        ...
        // Set up the response mock
        when(responseSpecMock.body(MetaDataListResponse.class)).thenReturn(expectedResponse);
    ...
    public void testCreateSegmentChildChunk() {
        ...
        // Set up the response mock
        when(responseSpecMock.body(SegmentChildChunkCreateResponse.class)).thenReturn(expectedResponse);
    ...
    public void testUpdateSegmentChildChunk() {
        ...
        // Set up the response mock
        when(responseSpecMock.body(SegmentChildChunkUpdateResponse.class)).thenReturn(expectedResponse);
    ...
    public void testCreateTag() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(TagInfoResponse.class)).thenReturn(expectedResponse);
    ...
    public void testListDatasetTag() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(DataSetTagsResponse.class)).thenReturn(expectedResponse);
    ...
    public void testChangeDocumentStatus() {
        ...
        when(responseSpecMock.body(DatasetStatusResponse.class)).thenReturn(expectedResponse);
        ...
        verify(responseSpecMock).body(DatasetStatusResponse.class);
    }
    ...
    public void testGetDocument() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(DocumentInfo.class)).thenReturn(expectedResponse);
    ...
    public void testGetSegment() {
        ...
        // Set up the response mock to return our expected response
        when(responseSpecMock.body(SegmentDataResponseDto.class)).thenReturn(new SegmentDataResponseDto(expectedResponse));
